    ...
    <main className="landing-main">
      ...
      <section className="hero">
        ...
        <p className="hero-subtitle">
          The elegant platform for digital wedding invitations, guest management, RSVP tracking, and vendor discovery.
        </p>
        <div className="btn-group">
          <Link href="/priya-and-kasun" className="btn-primary">
            <Eye size={20} /> View Demo Invitation
          </Link>
